		...
		<div class="tab-bang-gia-group">
			<ul class="nav nav-tabs" role="tablist">
				<li role="presentation" class="active">
					<a href="#gia-le-<?php echo $term->term_id; ?>" aria-controls="gia-le-<?php echo $term->term_id; ?>" role="tab" data-toggle="tab">GIÁ LẺ</a>
				</li>
				<li role="presentation">
					<a href="#gia-si-<?php echo $term->term_id; ?>" aria-controls="gia-si-<?php echo $term->term_id; ?>" role="tab" data-toggle="tab">GIÁ SỈ</a>
				</li>
			</ul>

			<div class="tab-content custom-tab-banggias">
				<div role="tabpanel" class="tab-pane active custom-tab-banggias" id="gia-le-<?php echo $term->term_id; ?>">
				...
				<div role="tabpanel" class="tab-pane" id="gia-si-<?php echo $term->term_id; ?>">
					<table class="table table-bordered">
						<tr>
							<td class="td-1">
								<div class="title-list-pro">
